...
namespace KnowledgeBase.BackendServer.UnitTest.Controllers
{
    public class UsersControllerTest
    {
        ...
        private List<User> _userSources = new List<User>(){
                             new User("1","test1", "FirstName 1", "Lastname 1", "test1@gmail.com", "001111111111", DateTime.Now),
                             new User("2","test2", "FirstName 2", "Lastname 2", "test2@gmail.com", "002222222222", DateTime.Now),
                             new User("3","test3", "FirstName 3", "Lastname 3", "test3@gmail.com", "003333333333", DateTime.Now),
                             new User("4","test4", "FirstName 4", "Lastname 4", "test4@gmail.com", "004444444444", DateTime.Now),
        ...
        public async Task GetUsersPaging_NoFilter_ReturnSuccess()
        {
            ...
            var okResult = result as OkObjectResult;
            var UserVms = okResult.Value as Panination<UserVm>;
